...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/touhid365/weather-app.git

2. **Navigate to the project directory**:
    ```bash
   cd weather-app
3. **Install dependencies (Assuming you're using a React setup)**:
...
- Click on the "Search" button or press Enter to view the weather details for the specified city.
...
## Contributing
- If you'd like to contribute, feel free to fork the repository and submit a pull request. Please make sure to follow the code style guidelines and write clear commit messages.
